...
public class UsersDAO {
	...
	private static Put mkPut(User u) {
		System.out.println(String.format("Creating Put for %s", u));
...
//		HTable table = new HTable(HBaseUtils.getConfiguration(), "users".getBytes());
//		Put p = new Put("tom12".getBytes());
//		p.addColumn("info".getBytes(), "user".getBytes(), "tom12".getBytes());
//		p.addColumn("info".getBytes(), "name".getBytes(), "tom".getBytes());
//		p.addColumn("info".getBytes(), "email".getBytes(), "tom@123".getBytes());
//		p.addColumn("info".getBytes(), "password".getBytes(), "123123".getBytes());
//		table.put(p);
//		table.close();
	}
	...
	public void addUser(String user, String name, String email, String password) throws IOException {
		...
		HTable table = new HTable(HBaseUtils.getConfiguration(), TABLE_NAME);
